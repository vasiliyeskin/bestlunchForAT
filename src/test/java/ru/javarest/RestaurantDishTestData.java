...
public class RestaurantDishTestData {
    ...
    public static final Dish LOBSTER_MAXWELL = new Dish(dish_id, "lobster", 10000, new Date(), rest_id + 1);
    public static final Dish BURGER_MAXWELL = new Dish(dish_id+1, "burger", 2000, new Date(), rest_id + 1);
    public static final Dish BORSH_MAXWELL = new Dish(dish_id+2, "borsh", 50000, new Date(), rest_id + 1);
    public static final Dish LOBSTER_FEYNMAN = new Dish(dish_id+3, "lobster", 55000, new Date(), rest_id + 2);
    public static final Dish BURGER_FEYNMAN = new Dish(dish_id+4, "burger", 2500, new Date(), rest_id + 2);
    public static final Dish BORSH_BOLTZMANN = new Dish(dish_id+5, "borsh", 30000, new Date(), rest_id);
